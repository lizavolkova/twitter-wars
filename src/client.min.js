...
/***/ function(module, exports) {
	...
	eval("module.exports = {\n\t\"serverUrL\": \"http://localhost:3000\"\n};\n\n/*****************\n ** WEBPACK FOOTER\n ** ./globals/config/config.dev.json\n ** module id = 183\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./globals/config/config.dev.json?");

/***/ },
/* 184 */
/***/ function(module, exports, __webpack_require__) {

	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.default = undefined;\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _NavContainer = __webpack_require__(185);\n\nvar _NavContainer2 = _interopRequireDefault(_NavContainer);\n\nvar _FooterContainer = __webpack_require__(188);\n\nvar _FooterContainer2 = _interopRequireDefault(_FooterContainer);\n\nvar _MainContainer = __webpack_require__(189);\n\nvar _MainContainer2 = _interopRequireDefault(_MainContainer);\n\nvar _UserContainer = __webpack_require__(190);\n\nvar _UserContainer2 = _interopRequireDefault(_UserContainer);\n\nvar _base = __webpack_require__(198);\n\nvar _base2 = _interopRequireDefault(_base);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\n//import FormInput from './components/generic-components/form/FormInput.jsx';\n\nvar App = function (_React$Component) {\n    _inherits(App, _React$Component);\n\n    function App(props) {\n        _classCallCheck(this, App);\n\n        var _this = _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, props));\n\n        var tweetIds = _this.getQueryParams();\n\n        _this.state = {\n            // sinceDate: '2014-10-15',\n            // untilDate: '2016-10-16'\n            permalink: 'https://localhost:8080/index.html?link=NjY3MDIzOTU3MzY3OTE0NDk2JjY2NjYzNjQyMzgxOTIwMjU2MA==',\n            sinceDate: '2015-11-17',\n            untilDate: '2015-11-19',\n            userLeft: {\n                userName: 'realDonaldTrump',\n                tweet_id: tweetIds[0]\n            },\n            userRight: {\n                userName: 'HillaryClinton',\n                tweet_id: tweetIds[1]\n            }\n        };\n        return _this;\n    }\n\n    _createClass(App, [{\n        key: 'getQueryParams',\n        value: function getQueryParams() {\n            return this.getPermalinkIds(window.location.href);\n        }\n    }, {\n        key: 'componentDidMount',\n        value: function componentDidMount() {\n            var _this2 = this;\n\n            twttr.ready(function () {\n                _this2.shuffleTweets();\n            });\n        }\n    }, {\n        key: 'shuffleTweets',\n        value: function shuffleTweets() {\n            var campaignStartDate = new Date(\"June 16, 2015\");\n            var today = new Date();\n            var untilDate = new Date(campaignStartDate.getTime() + Math.random() * (today.getTime() - campaignStartDate.getTime()));\n            var sinceDate = new Date(untilDate.getTime());\n            sinceDate.setDate(sinceDate.getDate() - 1);\n            this.setState({\n                sinceDate: sinceDate.toISOString().slice(0, 10),\n                untilDate: untilDate.toISOString().slice(0, 10)\n            });\n        }\n    }, {\n        key: 'onShuffle',\n        value: function onShuffle(e) {\n            e.preventDefault();\n            if (window.location.search) {\n                history.pushState(null, \"\", location.href.split(\"?\")[0]);\n            }\n\n            this.shuffleTweets();\n        }\n    }, {\n        key: 'getPermalinkIds',\n        value: function getPermalinkIds(url) {\n            var ids = [];\n            var searchQuery = /link=(.*)/.exec(url);\n\n            if (searchQuery && searchQuery[0].substring(0, 5) == 'link=') {\n                var decodedUrl = _base2.default.decode(searchQuery[0].substring(5, searchQuery[0].length));\n                if (decodedUrl.split('&').length === 2) {\n                    ids = decodedUrl.split('&').slice(0);\n                }\n            }\n\n            return ids;\n        }\n    }, {\n        key: 'setTweetPermalink',\n        value: function setTweetPermalink(tweet) {\n            var pastTweetIds = this.getPermalinkIds(this.state.permalink);\n            var newTweetIds = pastTweetIds.slice(0);\n\n            if (tweet.userName === 'realDonaldTrump') {\n                newTweetIds[0] = tweet.tweet_id;\n            } else {\n                newTweetIds[1] = tweet.tweet_id;\n            }\n\n            this.generatePermalink(newTweetIds);\n        }\n    }, {\n        key: 'generatePermalink',\n        value: function generatePermalink(ids) {\n            var urlParam = ids[0] + '&' + ids[1];\n            var encodedUrlParam = _base2.default.encode(urlParam);\n            this.setState({\n                permalink: 'http://' + window.location.host + '/index.html?link=' + encodedUrlParam\n            });\n        }\n    }, {\n        key: 'render',\n        value: function render() {\n            console.log('APP.JS RENDERING!');\n            return _react2.default.createElement(\n                _MainContainer2.default,\n                null,\n                _react2.default.createElement(\n                    'div',\n                    { className: 'row' },\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'col-md-6 col-sm-6 col-xs-6 col-left no-float' },\n                        _react2.default.createElement(_UserContainer2.default, {\n                            userName: this.state.userLeft.userName,\n                            sinceDate: this.state.sinceDate,\n                            untilDate: this.state.untilDate,\n                            tweet_id: this.state.userLeft.tweet_id,\n                            tweetIdReceived: this.setTweetPermalink.bind(this) })\n                    ),\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'col-md-6 col-sm-6 col-xs-6 col-right no-float' },\n                        _react2.default.createElement(_UserContainer2.default, {\n                            userName: this.state.userRight.userName,\n                            sinceDate: this.state.sinceDate,\n                            untilDate: this.state.untilDate,\n                            tweet_id: this.state.userRight.tweet_id,\n                            tweetIdReceived: this.setTweetPermalink.bind(this) })\n                    )\n                ),\n                _react2.default.createElement(\n                    'div',\n                    { className: 'shuffle-button' },\n                    _react2.default.createElement(\n                        'a',\n                        { href: '#', className: 'white-button', onClick: this.onShuffle.bind(this) },\n                        'Shuffle'\n                    ),\n                    _react2.default.createElement('a', { href: this.state.permalink })\n                ),\n                _react2.default.createElement(\n                    'div',\n                    { className: 'permalink' },\n                    _react2.default.createElement(\n                        'a',\n                        { href: this.state.permalink },\n                        'PERMALINK!'\n                    )\n                )\n            );\n        }\n    }]);\n\n    return App;\n}(_react2.default.Component);\n\nexports.default = App;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/App.js\n ** module id = 184\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/App.js?");

/***/ },
/* 185 */
/***/ function(module, exports, __webpack_require__) {

	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _Navitem = __webpack_require__(186);\n\nvar _Navitem2 = _interopRequireDefault(_Navitem);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Nav = function (_React$Component) {\n    _inherits(Nav, _React$Component);\n\n    function Nav() {\n        _classCallCheck(this, Nav);\n\n        return _possibleConstructorReturn(this, (Nav.__proto__ || Object.getPrototypeOf(Nav)).apply(this, arguments));\n    }\n\n    _createClass(Nav, [{\n        key: 'render',\n\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n        value: function render() {\n\n            return _react2.default.createElement(\n                'nav',\n                null,\n                _react2.default.createElement(\n                    'ul',\n                    null,\n                    _react2.default.createElement(_Navitem2.default, null),\n                    _react2.default.createElement(_Navitem2.default, null),\n                    _react2.default.createElement(_Navitem2.default, null)\n                )\n            );\n        }\n    }]);\n\n    return Nav;\n}(_react2.default.Component);\n\nexports.default = Nav;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/generic-components/nav/Nav.container.jsx\n ** module id = 185\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/generic-components/nav/Nav.container.jsx?");

/***/ },
/* 186 */
/***/ function(module, exports, __webpack_require__) {

	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _NavLink = __webpack_require__(187);\n\nvar _NavLink2 = _interopRequireDefault(_NavLink);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar NavItem = function (_React$Component) {\n    _inherits(NavItem, _React$Component);\n\n    function NavItem() {\n        _classCallCheck(this, NavItem);\n\n        return _possibleConstructorReturn(this, (NavItem.__proto__ || Object.getPrototypeOf(NavItem)).apply(this, arguments));\n    }\n\n    _createClass(NavItem, [{\n        key: 'render',\n\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n        value: function render() {\n\n            return _react2.default.createElement(\n                'li',\n                null,\n                _react2.default.createElement(_NavLink2.default, null)\n            );\n        }\n    }]);\n\n    return NavItem;\n}(_react2.default.Component);\n\nexports.default = NavItem;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/generic-components/nav/Navitem.jsx\n ** module id = 186\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/generic-components/nav/Navitem.jsx?");

/***/ },
/* 187 */
/***/ function(module, exports, __webpack_require__) {

	eval("\"use strict\";\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar NavLink = function (_React$Component) {\n    _inherits(NavLink, _React$Component);\n\n    function NavLink() {\n        _classCallCheck(this, NavLink);\n\n        return _possibleConstructorReturn(this, (NavLink.__proto__ || Object.getPrototypeOf(NavLink)).apply(this, arguments));\n    }\n\n    _createClass(NavLink, [{\n        key: \"render\",\n\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n        value: function render() {\n\n            return _react2.default.createElement(\n                \"a\",\n                { href: \"#\" },\n                \"LINK\"\n            );\n        }\n    }]);\n\n    return NavLink;\n}(_react2.default.Component);\n\nexports.default = NavLink;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/generic-components/nav/NavLink.jsx\n ** module id = 187\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/generic-components/nav/NavLink.jsx?");

/***/ },
/* 188 */
/***/ function(module, exports, __webpack_require__) {

	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Footer = function (_React$Component) {\n    _inherits(Footer, _React$Component);\n\n    function Footer() {\n        _classCallCheck(this, Footer);\n\n        return _possibleConstructorReturn(this, (Footer.__proto__ || Object.getPrototypeOf(Footer)).apply(this, arguments));\n    }\n\n    _createClass(Footer, [{\n        key: 'render',\n\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n        value: function render() {\n\n            return _react2.default.createElement(\n                'footer',\n                null,\n                this.props.children\n            );\n        }\n    }]);\n\n    return Footer;\n}(_react2.default.Component);\n\nexports.default = Footer;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/generic-components/footer/Footer.container.jsx\n ** module id = 188\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/generic-components/footer/Footer.container.jsx?");

/***/ },
/* 189 */
/***/ function(module, exports, __webpack_require__) {

	eval("\"use strict\";\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Main = function (_React$Component) {\n    _inherits(Main, _React$Component);\n\n    function Main() {\n        _classCallCheck(this, Main);\n\n        return _possibleConstructorReturn(this, (Main.__proto__ || Object.getPrototypeOf(Main)).apply(this, arguments));\n    }\n\n    _createClass(Main, [{\n        key: \"render\",\n\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n        value: function render() {\n\n            return _react2.default.createElement(\n                \"div\",\n                { className: \"container\" },\n                this.props.children\n            );\n        }\n    }]);\n\n    return Main;\n}(_react2.default.Component);\n\nexports.default = Main;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/generic-components/main/Main.container.jsx\n ** module id = 189\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/generic-components/main/Main.container.jsx?");

/***/ },
/* 190 */
/***/ function(module, exports, __webpack_require__) {

	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _TwitterProfileContainer = __webpack_require__(191);\n\nvar _TwitterProfileContainer2 = _interopRequireDefault(_TwitterProfileContainer);\n\nvar _TwitterWidgetContainer = __webpack_require__(196);\n\nvar _TwitterWidgetContainer2 = _interopRequireDefault(_TwitterWidgetContainer);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar User = function (_React$Component) {\n    _inherits(User, _React$Component);\n\n    function User(props) {\n        _classCallCheck(this, User);\n\n        var _this = _possibleConstructorReturn(this, (User.__proto__ || Object.getPrototypeOf(User)).call(this, props));\n\n        _this.state = {\n            userData: {\n                userName: _this.props.userName,\n                description: 'description',\n                name: 'name',\n                screen_name: '@user',\n                // profile_image_url: 'http://www.clker.com/cliparts/A/Y/O/m/o/N/placeholder-md.png',\n                profile_image_url: ''\n            },\n            tweetData: {\n                userName: _this.props.userName,\n                sinceDate: _this.props.sinceDate,\n                untilDate: _this.props.untilDate,\n                tweet_id: _this.props.tweet_id\n            }\n        };\n        return _this;\n    }\n\n    _createClass(User, [{\n        key: 'componentWillReceiveProps',\n        value: function componentWillReceiveProps(nextProps) {\n            this.setState({\n                tweetData: {\n                    userName: this.props.userName,\n                    sinceDate: nextProps.sinceDate,\n                    untilDate: nextProps.untilDate,\n                    tweet_id: this.props.tweet_id\n                }\n            });\n        }\n    }, {\n        key: 'setTweetId',\n        value: function setTweetId(tweet_id) {\n            this.props.tweetIdReceived(tweet_id);\n        }\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n\n    }, {\n        key: 'render',\n        value: function render() {\n            if (twttr.events) {\n                return _react2.default.createElement(\n                    'div',\n                    { className: 'comp-user' },\n                    _react2.default.createElement(_TwitterProfileContainer2.default, { userData: this.state.userData }),\n                    _react2.default.createElement(_TwitterWidgetContainer2.default, {\n                        tweetData: this.state.tweetData,\n                        hasFetchedTweetData: this.setTweetId.bind(this) })\n                );\n            } else {\n                return _react2.default.createElement(\n                    'div',\n                    { className: 'comp-user' },\n                    _react2.default.createElement(_TwitterProfileContainer2.default, { userData: this.state.userData })\n                );\n            }\n        }\n    }]);\n\n    return User;\n}(_react2.default.Component);\n\nexports.default = User;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/app-components/user/User.container.jsx\n ** module id = 190\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/app-components/user/User.container.jsx?");

/***/ },
/* 191 */
/***/ function(module, exports, __webpack_require__) {

	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _dec, _class;\n\nvar _react = __webpack_require__(1);\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _classnames = __webpack_require__(192);\n\nvar _classnames2 = _interopRequireDefault(_classnames);\n\nvar _reactRedux = __webpack_require__(159);\n\nvar _TwitterProfileActions = __webpack_require__(193);\n\nvar _ImageFadeContainer = __webpack_require__(195);\n\nvar _ImageFadeContainer2 = _interopRequireDefault(_ImageFadeContainer);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar TwitterProfile = (_dec = (0, _reactRedux.connect)(function (store, props) {\n    var userData = store.users.filter(function (user) {\n        return user.screen_name === props.userData.userName;\n    })[0] ? store.users.filter(function (user) {\n        return user.screen_name === props.userData.userName;\n    })[0] : store.users[0];\n    return {\n        user: userData\n    };\n}), _dec(_class = function (_React$Component) {\n    _inherits(TwitterProfile, _React$Component);\n\n    function TwitterProfile(props) {\n        _classCallCheck(this, TwitterProfile);\n\n        var _this = _possibleConstructorReturn(this, (TwitterProfile.__proto__ || Object.getPrototypeOf(TwitterProfile)).call(this, props));\n\n        _this.props.dispatch((0, _TwitterProfileActions.createNewUser)(_this.props.userData));\n        return _this;\n    }\n\n    _createClass(TwitterProfile, [{\n        key: 'componentDidMount',\n        value: function componentDidMount() {\n            this.props.dispatch((0, _TwitterProfileActions.getProfileData)(this.props.userData.userName));\n        }\n\n        /**\r\n         * Render component\r\n         * @returns {XML}\r\n         */\n\n    }, {\n        key: 'render',\n        value: function render() {\n            var fetchingDivClass = (0, _classnames2.default)({\n                'tweet-profile-fetching': true,\n                'hide': !this.props.user.fetching\n            });\n\n            var errorDivClass = (0, _classnames2.default)({\n                'tweet-profile-error': true,\n                'hide': !this.props.user.error\n            });\n\n            var profileBackroundStyle = this.props.user.background_image_url ? { backgroundImage: 'linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(' + this.props.user.background_image_url + ')' } : { backgroundImage: 'url(' + this.props.user.background_image_url + ')' };\n\n            var displayName = this.props.user.fetching || this.props.user.error ? '@' + this.props.user.userName : this.props.user.name;\n\n            return _react2.default.createElement(\n                'div',\n                { className: 'tweet-profile-container' },\n                _react2.default.createElement(\n                    'div',\n                    { className: 'tweet-profile-wrapper' },\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'profile-background' },\n                        _react2.default.createElement(_ImageFadeContainer2.default, { src: this.props.user.background_image_url })\n                    ),\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'tweet-profile-user-name' },\n                        displayName\n                    ),\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'tweet-profile-white-bar' },\n                        _react2.default.createElement(\n                            'span',\n                            { className: 'tweet-profile-user-name' },\n                            displayName\n                        ),\n                        _react2.default.createElement(\n                            'span',\n                            { className: 'tweet-profile-divider-bar first' },\n                            '\\xA0\\xA0\\xA0|\\xA0\\xA0\\xA0'\n                        ),\n                        _react2.default.createElement(\n                            'span',\n                            { className: 'tweet-profile-screen-name' },\n                            '@',\n                            this.props.user.userName\n                        ),\n                        _react2.default.createElement(\n                            'span',\n                            { className: 'tweet-profile-divider-bar second' },\n                            '\\xA0\\xA0\\xA0|\\xA0\\xA0\\xA0'\n                        ),\n                        _react2.default.createElement(\n                            'span',\n                            { className: 'tweet-profile-website' },\n                            _react2.default.createElement(\n                                'a',\n                                { href: this.props.user.url, target: '_blank' },\n                                this.props.user.display_url\n                            )\n                        )\n                    ),\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'tweet-profile-content' },\n                        _react2.default.createElement(\n                            'div',\n                            { className: '' },\n                            _react2.default.createElement(\n                                'div',\n                                { className: 'tweet-profile-avatar ' },\n                                _react2.default.createElement('img', { src: 'http://www.clker.com/cliparts/A/Y/O/m/o/N/placeholder-md.png', className: 'tweet-profile-placeholder', alt: '' }),\n                                _react2.default.createElement(_ImageFadeContainer2.default, { src: this.props.user.profile_image_url })\n                            ),\n                            _react2.default.createElement(\n                                'div',\n                                { className: 'tweet-profile-body' },\n                                _react2.default.createElement('div', { className: 'tweet-profile-bio' })\n                            )\n                        )\n                    )\n                )\n            );\n        }\n    }]);\n\n    return TwitterProfile;\n}(_react2.default.Component)) || _class);\nexports.default = TwitterProfile;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./js/components/app-components/twitter-profile/TwitterProfile.container.jsx\n ** module id = 191\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./js/components/app-components/twitter-profile/TwitterProfile.container.jsx?");
